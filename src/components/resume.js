                ...
                return (
                  <div key={i} className="row item">
                    <div className="twelve columns">
                      ...
                      <p className="info">
                        {item.specialization}
              <span>&bull;</span> <em className="date">{item.MonthOfPassing} {item.YearOfPassing} - {item.MonthOfGraduation} {item.YearOfGraduation}</em></p>
                      <p>
                        {item.Achievements}
                      </p>
                    </div>
          ...
          <div className="nine columns main-col">
            {
              resumeData.work && resumeData.work.map((item, i) => {
                ...
                <span>&bull;</span> <em className="date"> {item.MonthOfStarting} {item.YearOfStarting} - {item.MonthOfLeaving} {item.YearOfLeaving}</em></p>
                      <p>
                        <ul>
                          <li><span>&bull;</span> {item.description1}</li>
                          <li><span>&bull;</span> {item.description2}</li>
                        </ul>
                      </p>
                    </div>
                    ...
                    <h3>{item.projectName}</h3>
                      <p>
                        <ul>
                          <li><span>&bull;</span> {item.description1}</li>
                          <li><span>&bull;</span> {item.description2}</li>
                          <li><span>&bull;</span> {item.description3}</li>
                        </ul>
                      </p>
                    </div>
